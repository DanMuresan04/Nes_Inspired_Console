...
entity udp_ip is
    Port (
        ...
        -- ==========================================
        -- NEW RX AXI4-Stream & Metadata Ports
        -- ==========================================
        m_axis_rx_tdata   : out std_logic_vector(7 downto 0);
        m_axis_rx_tvalid  : out std_logic;
        m_axis_rx_tlast   : out std_logic;
        
        meta_rx_data      : out std_logic;
        meta_rx_wen       : out std_logic
    );
end udp_ip;
...
architecture Behavioral of udp_ip is
    ...
    Port (
        ...
        -- New AXI and Meta ports in component
